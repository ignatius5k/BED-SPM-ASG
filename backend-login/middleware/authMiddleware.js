...
// Public pages may show reviews to guests, while still identifying the owner
// when a valid login token is available. Invalid supplied tokens are rejected
// instead of being trusted or silently treated as another user.
